...
{
    /**
     * @Route("orders/", name="app_order_detail_index", methods={"GET"})
     */
    ...
    /**
     * @Route("orders/new", name="app_order_detail_new", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("orders/{id}", name="app_order_detail_show", methods={"GET"})
     */
    ...
    /**
     * @Route("orders/{id}/edit", name="app_order_detail_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("orders/{id}", name="app_order_detail_delete", methods={"POST"})
     */
